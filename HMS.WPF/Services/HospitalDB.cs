...
namespace HMS.WPF.Services
{
    static class HospitalDB
    {
        ...
        public static List<AppointmentPatient> FetchAppointmentPatients()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        //AppointmentPatientID = reader.GetString("patient_id"),
                        //Name = reader.GetString("name"),
                        //BirthDate = reader.GetDateTime("birth_date"),
                        //Address = reader.GetString("address"),
                        //Diagnosis = reader.GetString("diagnosis"),
        ...
        public async static void InsertDepartment(Department department)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"INSERT INTO department VALUES('{department.DepartmentID}', '{department.Name}')";
                SqlCommand command = new SqlCommand(query, con);
        ...
        public async static void InsertDoctor(Doctor doctor)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"INSERT INTO doctor VALUES('{doctor.PersonID}', '{doctor.Name}', " +
                    $"'{doctor.BirthDate.ToString("yyyy-MM-dd")}', '{doctor.Address}', '{doctor.EmploymentDate.ToString("yyyy-MM-dd")}', '{doctor.Department.DepartmentID}'," +
        ...
        public async static void InsertNurse(Nurse nurse)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"INSERT INTO nurse VALUES('{nurse.PersonID}', '{nurse.Name}', " +
        ...
        public async static void InsertPatient(Patient patient)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"INSERT INTO patient VALUES('{patient.PersonID}', '{patient.Name}', " +
                ...
                {
                    query = $"INSERT INTO resident_patient VALUES('{patient.PersonID}', '{((ResidentPatient)patient).Room.RoomID}', " +
                        $"'{((ResidentPatient)patient).Department.DepartmentID}', '{((ResidentPatient)patient).EntryDate.ToString("yyy-MM-dd")}')";
        ...
        public async static void InsertAppointment(Appointment appointment)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"INSERT INTO appointment VALUES('{appointment.AppointmentID}', '{appointment.Patient.PersonID}', " +
                    $"'{appointment.Doctor.PersonID}', '{appointment.Date}', {appointment.Duration})";
                SqlCommand command = new SqlCommand(query, con);
                await command.ExecuteNonQueryAsync();
            }
            catch
        ...
        public async static void InsertMedicine(Medicine medicine, Patient patient)
        {
            ...
            try
            {
                ...
                String query = $"INSERT INTO medicine VALUES('{medicine.MedecineID}', '{medicine.Name}', " +
                    $"'{medicine.StartingDate}', '{medicine.EndingDate}', '{patient.PersonID}')";
                SqlCommand command = new SqlCommand(query, con);
                await command.ExecuteNonQueryAsync();
            }
            catch
        ...
        public async static void UpdateDoctor(Doctor doctor)
        {
            ...
            try
            {
                ...
                String query = $"UPDATE doctor SET Name = '{doctor.Name}', BirthDate = '{doctor.BirthDate}', " +
                    ...
                    $"WHERE DoctorID = '{doctor.PersonID}'";
                SqlCommand command = new SqlCommand(query, con);
                await command.ExecuteNonQueryAsync();
            }
            catch
        ...
        public async static void UpdateAppointment(Appointment appointment)
        {
            ...
            {
                await con.OpenAsync();
                String query = $"UPDATE Appointment SET PatientID = '{appointment.Patient.PersonID}', DoctorID = '{appointment.Doctor.PersonID}', " +
        ...
        public async static void UpdatePatient(Patient patient)
        {
            ...
            try
            {
                ...
                String query = $"UPDATE patient SET name = '{patient.Name}', birth_date = '{patient.BirthDate}', " +
                    ...
                    $"WHERE patient_id = '{patient.PersonID}'";
                SqlCommand command = new SqlCommand(query, con);
                await command.ExecuteNonQueryAsync();

                if (patient.GetType() == typeof(ResidentPatient))
                {
                    query = $"UPDATE resident_patient SET room_id = '{((ResidentPatient)patient).Room.RoomID}', " +
                        $"department_id = '{((ResidentPatient)patient).Department.DepartmentID}', " +
