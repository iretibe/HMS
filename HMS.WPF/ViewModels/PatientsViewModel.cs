    ...
    public class PatientsViewModel : BaseViewModel
    {
        ...
        public PatientsViewModel()
        {
            ...
            foreach (Room room in Hospital.Rooms.Values)
            {
                if (room.hasAvailableBed())
                    ComboBoxItems.Add(new ComboBoxPairs(room.RoomID, room.RoomNumber.ToString()));
            }

            foreach (Department department in Hospital.Departments.Values)
            {
                PatientDepartmentItems.Add(new ComboBoxPairs(department.DepartmentID, department.Name));
            }
        ...
        public void addPatient()
        {
            ...
            if (PatientTypeComboBox == "Resident Patient")
            {
                ...
                Hospital.Departments[PatientDepartment.Key].Patients.Add(newPatient.PersonID, newPatient);
                Hospital.Patients.Add(newPatient.PersonID, newPatient);
                Hospital.Rooms[RoomNumber.Key].Patients.Add(newPatient.PersonID, newPatient);
