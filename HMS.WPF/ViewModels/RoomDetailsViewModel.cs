    ...
    public class RoomDetailsViewModel : BaseViewModel
    {
        ...
        public RoomDetailsViewModel(string ID)
        {
            ...
            foreach (Employee nurse in Hospital.Employees.Values)
            {
                ...
                {
                    if (nurse.PersonID == invalidNurse.PersonID && nurse.GetType() == typeof(Nurse))
                    {
                        valid = false;
                    }
                }
                ...
                {
                    NursesComboBoxItems.Add(new ComboBoxPairs(nurse.PersonID, nurse.Name));
                }
            }
        ...
        public async void RemoveNurse()
        {
            ...
            if (result.Equals(true))
            {
                ...
                {
                    ((Nurse)Hospital.Employees[ListSelectedNurse.Key]).Patients.Remove(patient.PersonID);
                }
        ...
        public void AssignNurse()
        {
            ...
            foreach (Patient patient in Hospital.Rooms[RoomID].Patients.Values)
            {
                ((Nurse)Hospital.Employees[NurseSelectedItem.Key]).Patients.Add(patient.PersonID, patient);
            }
