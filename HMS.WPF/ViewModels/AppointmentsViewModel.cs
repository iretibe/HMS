    ...
    public class AppointmentsViewModel : BaseViewModel
    {
        ...
        public AppointmentsViewModel()
        {
            ...
            foreach (var patient in Models.Hospital.Patients.Values)
            {
                ...
                {
                    patientsComboBoxItems.Add(new Models.ComboBoxPairs(patient.PersonID, patient.Name));
                }
            }
            ...
            foreach (var employee in Models.Hospital.Employees.Values)
            {
                ...
                {
                    doctorsComboBoxItems.Add(new Models.ComboBoxPairs(employee.PersonID, employee.Name));
                }
            }
        ...
        {
            Models.Hospital.Appointments[ID].Doctor.removePatient(Models.Hospital.Appointments[ID].Patient.PersonID);
