    ...
    class Hospital
    {
        ...
        public static void InitializeEmployees()
        {
            ...
            foreach (Doctor doctor in doctorList)
            {
                ...
                string departmentID = HospitalDB.FetchPersonDepartment(doctor.PersonID.ToString());
                ...
                if (Departments.ContainsKey(departmentID))
                {
                    ...
                    if (doctor.IsHead)
                        Departments[departmentID].HeadID = doctor.PersonID;
                }


                Employees.Add(doctor.PersonID, doctor);
            }
            ...
            foreach (Nurse nurse in nurseList)
            {
                ...
                String departmentID = HospitalDB.FetchPersonDepartment(nurse.PersonID);
                ...
                List<String> roomsID = HospitalDB.FetchNurseRooms(nurse.PersonID);
                ...
                Employees.Add(nurse.PersonID, nurse);
            }
        }
        ...
        public static void InitializePatients()
        {
            ...
            foreach (Patient patient in patientList)
            {
                ...
                List<String> doctorsIDs = HospitalDB.FetchPatientDoctors(patient.PersonID);
                ...
                if (patient.GetType() == typeof(ResidentPatient))
                {
                    ...
                    String departmentID = HospitalDB.FetchPersonDepartment(patient.PersonID);
                    if (Departments.ContainsKey(departmentID))
                    {
                        ((ResidentPatient)patient).Department = Departments[departmentID];
                        Departments[departmentID].Patients.Add(patient.PersonID, patient);
                    }

                    //Fetching Patient's Room from Database
                    String roomID = HospitalDB.FetchPatientRoom(patient.PersonID);
                    ...
                    List<Medicine> medicineList = HospitalDB.FetchMedicine(patient.PersonID);
                    foreach (Medicine medicine in medicineList)
                    {
                        ((ResidentPatient)patient).addMedicine(new Medicine
                        {
                            MedecineID = medicine.MedecineID,
                            Name = medicine.Name,
                ...
                Patients.Add(patient.PersonID, patient);
            }
        }
        ...
        public static void InitializeAppointments()
        {
            ...
            foreach (Appointment appointment in appointmentList)
            {
                ...
                String patientID = HospitalDB.FetchAppointmentPatient(appointment.AppointmentID.ToString());
                ...
                String doctorID = HospitalDB.FetchAppointmentDoctor(appointment.AppointmentID.ToString());
                ...
                Appointments.Add(appointment.AppointmentID.ToString(), appointment);
            }
        }
